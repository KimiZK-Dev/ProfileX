...
`,
		...
		class r {
			...
			#h = (s) => {
				...
				return (
					(i.className = `fui-toast top-eff-show ${
						s.className ?? ""
					}`),
					(i.dataset.id = s.id),
					(i.innerHTML = t({
					...
					s.style &&
						Object.assign(
							i.querySelector(".fui-toast-box").style,
							s.style
						),
					this.#l(s, i),
					s.isClose &&
			...
			#l = (t, s) => {
				let e =
					"function" == typeof t.message ? t.message(t) : t.message;
				if (e && s) {
			...
			updateToast = (t) => {
				...
				o(e) && (e = a(e)),
					...
					t.title &&
						(s.querySelector(".fui-toast-title").innerHTML =
							t.title),
					this.#l(t, s),
					this.#j();
			};
			...
			#j = (t) => {
				if (
					(0 !== this.#d.length &&
						(this.#d.forEach((t) => t && clearTimeout(t)),
						(this.#d = [])),
					t)
				)
					return this;
			...
			dismiss = (t) => {
				let s = this.#m(t);
				return (
					s && (s.classList.add("top-eff-hidden"), this.#p(t)), this
				);
			};
			#p = (t) => {
